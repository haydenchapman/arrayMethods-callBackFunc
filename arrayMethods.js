...
// CODE HERE
const myStrongest = monstersInYourPocket.filter(num => num.CP >= 200).map(num => num.CP)
...
// CODE HERE
const totals = orders.filter(num => num).map(num => num.price * (num.tax + 1))
//console.log(totals)
...
*/
// CODE HERE
const sumOfBob = purchases.filter(num => num.owner.includes('Bob')).map(num => num.price)

console.log(sumOfBob)