...
*/
// CODE HERE
function multiply(num1, num2, times) {
...
*/
// CODE HERE
let printUniq = (uniqArr) => { 
  console.log(`The new names array with all the duplicate items removed is ${uniqArr}`)
}
uniq(names, printUniq) 
////////// PROBLEM 6 //////////
/* 
...
*/
// CODE HERE
let withIndex = (names, index) => {
  console.log(`The item at index ${index} is ${names}.`)
}
each(names, withIndex)
...
*/
// CODE HERE
let addNUMBER = addingFactory(77)
addNUMBER(12)